...
d<-read_csv("210121_HSCAllBatches_cleaned.csv")
...
cor.test(subset(df_BA, Species=="C.albicans")$RAD50.B1,
         subset(df_BA, Species=="C.albicans")$RAD50.B2)
...
#BA resistance Calb
plot(seq_along(subset(df_BA, Species=="C.albicans")$RAD50.B1), subset(df_BA, Species=="C.albicans")$RAD50.B1, col="red", ylim=c(30, 0))
points(seq_along(subset(df_BA, Species=="C.albicans")$RAD50.B1), subset(df_BA, Species=="C.albicans")$RAD50.B2, col="orange")
points(seq_along(subset(df_BA, Species=="C.albicans")$RAD50.B1), subset(df_BA, Species=="C.albicans")$RAD50.Comb, col="blue")

#BA tolerance Calb
plot(seq_along(subset(df_BA, Species=="C.albicans")$FoG50.B1), subset(df_BA, Species=="C.albicans")$FoG50.B1, col="red", ylim=c(0, 1))
points(1:71, subset(df_BA, Species=="C.albicans")$FoG50.B2, col="orange")
points(seq_along(subset(df_BA, Species=="C.albicans")$RAD50.B1), subset(df_BA, Species=="C.albicans")$FoG50.Comb, col="blue")

#BA resistance Cglab
plot(seq_along(subset(df_BA, Species=="C.glabrata")$RAD50.B1), subset(df_BA, Species=="C.glabrata")$RAD50.B1, col="red", ylim=c(30, 0))
points(seq_along(subset(df_BA, Species=="C.glabrata")$RAD50.B1), subset(df_BA, Species=="C.glabrata")$RAD50.B2, col="orange")
points(seq_along(subset(df_BA, Species=="C.glabrata")$RAD50.B1), subset(df_BA, Species=="C.glabrata")$RAD50.Comb, col="blue")

#BA tolerance Calb
plot(seq_along(subset(df_BA, Species=="C.glabrata")$FoG50.B1), subset(df_BA, Species=="C.glabrata")$FoG50.B1, col="red", ylim=c(0, 1))
points(seq_along(subset(df_BA, Species=="C.glabrata")$FoG50.B1), subset(df_BA, Species=="C.glabrata")$FoG50.B2, col="orange")
points(seq_along(subset(df_BA, Species=="C.glabrata")$RAD50.B1), subset(df_BA, Species=="C.glabrata")$FoG50.Comb, col="blue")

#FLC resistance Calb
plot(seq_along(subset(df_FLC, Species=="C.albicans")$RAD50.B1), subset(df_FLC, Species=="C.albicans")$RAD50.B1, col="red", ylim=c(30, 0))
points(seq_along(subset(df_FLC, Species=="C.albicans")$RAD50.B1), subset(df_FLC, Species=="C.albicans")$RAD50.B2, col="orange")
points(seq_along(subset(df_FLC, Species=="C.albicans")$RAD50.B1), subset(df_FLC, Species=="C.albicans")$RAD50.Comb, col="blue")

#FLC tolerance Calb
plot(seq_along(subset(df_FLC, Species=="C.albicans")$FoG50.B1), subset(df_FLC, Species=="C.albicans")$FoG50.B1, col="red", ylim=c(0, 1))
points(seq_along(subset(df_FLC, Species=="C.albicans")$FoG50.B1), subset(df_FLC, Species=="C.albicans")$FoG50.B2, col="orange")
points(seq_along(subset(df_FLC, Species=="C.albicans")$RAD50.B1), subset(df_FLC, Species=="C.albicans")$FoG50.Comb, col="blue")

#FLC resistance Cglab
plot(seq_along(subset(df_FLC, Species=="C.glabrata")$RAD50.B1), subset(df_FLC, Species=="C.glabrata")$RAD50.B1, col="red", ylim=c(30, 0))
points(seq_along(subset(df_FLC, Species=="C.glabrata")$RAD50.B1), subset(df_FLC, Species=="C.glabrata")$RAD50.B2, col="orange")
points(seq_along(subset(df_FLC, Species=="C.glabrata")$RAD50.B1), subset(df_FLC, Species=="C.glabrata")$RAD50.Comb, col="blue")

#FLC tolerance Cglab
plot(seq_along(subset(df_FLC, Species=="C.glabrata")$FoG50.B1), subset(df_FLC, Species=="C.glabrata")$FoG50.B1, col="red", ylim=c(0, 1))
points(seq_along(subset(df_FLC, Species=="C.glabrata")$FoG50.B1), subset(df_FLC, Species=="C.glabrata")$FoG50.B2, col="orange")
points(seq_along(subset(df_FLC, Species=="C.glabrata")$RAD50.B1), subset(df_FLC, Species=="C.glabrata")$FoG50.Comb, col="blue")
