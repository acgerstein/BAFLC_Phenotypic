...
H1_df<-rbind(H1B1, H1B2, Type="HSC_2012")
...
H2_df<-rbind(H2B1, H2B2, Type="HSC_2018")
...
Sep1218<-HSC%>%subset(Strain%in%Comb1218$Strain) %>% mutate(Type="Sep")

CombSep<-rbind(Comb1218,Sep1218)
