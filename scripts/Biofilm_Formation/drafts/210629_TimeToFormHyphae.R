...
#ggsave(here("figures_out","Biofilm_Formation","2106026_Time_to_Hyphae_BA.jpg"), width = 5, height = 3, plot=BA)
...
#ggsave(here("figures_out","Biofilm_Formation","210626_Time_to_Hyphae_FLC.jpg"), width = 5, height = 3, plot=FLC)
