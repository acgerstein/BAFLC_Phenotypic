...
param_all_long <- ggarrange(k_BA,k_FLC, r_BA, r_FLC, t_asym_BA,  
          t_asym_FLC, common.legend = TRUE,
          ncol = 2,
          nrow = 3,
          legend = "right")
...
ggsave(here("figures_out", "Biofilm_Formation", "210626_AllParams_B01B02.jpg"), 
       param_all, 
       width = 12, height = 6)

ggsave(here("figures_out", "Biofilm_Formation", "210624_AllParams_long_B01B02.jpg"), 
       param_all_long, 
       width = 8, height = 10)
